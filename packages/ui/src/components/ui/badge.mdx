...
function TaskPriority({ priority }) {
  const priorityMap = {
    high: { variant: 'destructive', label: 'High Priority', icon: '🔥' },
    medium: { variant: 'default', label: 'Medium', icon: '⚡' },
...
- ✅ **Sufficient Contrast**: All variants meet WCAG AA contrast requirements
- ✅ **Semantic HTML**: Uses span element by default
- ✅ **Screen Reader Friendly**: Text content is announced properly
- ✅ **Color Independence**: Meaning isn't conveyed by color alone
