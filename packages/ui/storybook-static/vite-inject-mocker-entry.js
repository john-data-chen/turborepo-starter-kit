import { _ as me } from './assets/preload-helper-PPVm8Dsz.js'
class se {
  ...
  register(e, t, r, i, s) {
    ...
    if (typeof t !== 'string') {throw new TypeError('[vitest] Mocks require a raw string.')}
    if (typeof i !== 'string') {throw new TypeError('[vitest] Mocks require a url string.')}
    if (typeof r !== 'string') {throw new TypeError('[vitest] Mocks require an id string.')}
    if (a === 'manual') {
      if (typeof s !== 'function') {throw new TypeError('[vitest] Manual mocks require a factory function.')}
      ...
      if (typeof s !== 'string') {throw new TypeError('[vitest] Redirect mocks require a redirect string.')}
      const o = new C(t, r, i, s)
      return (this.add(o), o)
    }throw new Error(`[vitest] Unknown mock type: ${a}`)
  }
  delete(e) {
...
class C {
  ...
  toJSON() {
    return { type: this.type, url: this.url, raw: this.raw, id: this.id, redirect: this.redirect }
  }
}
class F {
  cache
  ...
  const r = new Array(),
    ...
    a = (l, d) => {
      ...
      for (const { key: w, descriptor: b } of K(l, g, n.globalConstructors)) {
        ...
        const x = u.includes('Function') && typeof y === 'function'
        if ((!x || y._isMockFunction) && u !== 'Object' && u !== 'Module') {
          s(d, w, y)
          continue
        }
        if (s(d, w, x ? y : {})) {
          if (x) {
            let _ = function () {
              if (this instanceof d[w])
                {for (const { key: I, descriptor: R } of K(this, !1, n.globalConstructors)) {
                  if (R.get) continue
                  const N = this[I]
                  if (D(N).includes('Function') && typeof N == 'function') {
                    const L = this[I],
                      ...
                      $ = f.mockReset
                    f.mockRestore = f.mockReset = () => ($.call(f), f.mockImplementation(L), f)
                  }
                }}
            }
            if (!n.spyOn)
            ...
            if (n.type === 'automock') {
              ...
              const I = P.mockReset
              P.mockRestore = P.mockReset = () => (I.call(P), P.mockImplementation(_), P)
            }
            Object.defineProperty(d[w], 'length', { value: 0 })
          }
          ;(i.track(y, d[w]), a(y, d[w]))
        }
      }
    },
    o = t
...
function ve(n, e) {
  return (
    e.includes('Function') && typeof n === 'string' && ['arguments', 'callee', 'caller', 'length', 'name'].includes(n)
  )
}
function K(n, e, t) {
...
function we(n, e) {
  ...
  ;(Object.getOwnPropertyNames(n).forEach(t), Object.getOwnPropertySymbols(n).forEach(t))
}
const ke = /^[A-Za-z]:\//
function ce(n = '') {
      ...
      n.length === 0
        ? t
          ...
          : r
            ? './'
            : '.'
        : (r && (n += '/'), Ee.test(n) && (n += '/'), e ? (t ? `//${n}` : `//./${n}`) : t && !H(n) ? `/${n}` : n)
    )
  },
  xe = function (...n) {
    let e = ''
...
function Te(n, e) {
  ...
  for (let o = 0; o <= n.length; ++o) {
    ...
    if (a === '/') {
      if (!(i === o - 1 || s === 1))
        {if (s === 2) {
          if (t.length < 2 || r !== 2 || t[t.length - 1] !== '.' || t[t.length - 2] !== '.') {
            if (t.length > 2) {
              const l = t.lastIndexOf('/')
              ;(l === -1 ? ((t = ''), (r = 0)) : ((t = t.slice(0, l)), (r = t.length - 1 - t.lastIndexOf('/'))),
                (i = o),
                (s = 0))
              continue
            } else if (t.length > 0) {
...
function Ae(n = !1) {
  let e = Re(n),
    t = (a, o, l, d) => {
      let h = '',
        g = 0
      do {((h += a.substring(g, d) + l), (g = d + o.length), (d = a.indexOf(o, g)))}
      while (~d)
...
function le(n) {
  return n && n.__esModule && Object.hasOwn(n, 'default') ? n.default : n
}
const U = { exports: {} },
  k = {}
/**
...
function Oe() {
  if (Z) {return k}
  Z = 1
  const n = Symbol.for('react.transitional.element'),
...
let De = () => 'Promise{…}'
try {
  const { getPromiseDetails: n, kPending: e, kRejected: t } = process.binding('util')
  Array.isArray(n(Promise.resolve())) &&
    (De = (r, i) => {
      const [s, a] = n(r)
      return s === e ? 'Promise{<pending>}' : `Promise${s === t ? '!' : ''}{${i.inspect(a, i)}}`
    })
} catch {}
function Ue(n) {
  const { message: e = '$$stack trace error', stackTraceLimit: t = 1 } = n || {},
...
function ze() {
  if (te) {return V}
  te = 1
  let n, e, t, r, i, s, a, o, l, d, h, g, w, b, y, c, u, x, M
  return (
    (w = /\/(?![*/])(?:\[(?:(?![\]\\]).|\\.)*\]|(?![/\\]).|\\.)*(\/[$_\u200C\u200D\p{ID_Continue}]*|\\)?/uy),
    (g =
      /--|\+\+|=>|\.{3}|\??\.(?!\d)|(?:&&|\|\||\?\?|[+\-%&|^]|\*{1,2}|<{1,2}|>{1,3}|!=?|={1,2}|\/(?![/*]))=?|[?~,:;[\](){}]/y),
    (n = /(\x23?)(?=[$_\p{ID_Start}\\])(?:[$_\u200C\u200D\p{ID_Continue}]|\\u[\da-fA-F]{4}|\\u\{[\da-fA-F]+\})+/uy),
    (y = /(['"])(?:(?!\1)[^\\\n\r]|\\(?:\r\n|[^]))*(\1)?/y),
    (h =
    ...
    (u = /^(?:=>|[;\]){}]|else|\?(?:NoLineTerminatorHere|NonExpressionParenEnd))?$/),
    ...
    (V = function* (_, { jsx: P = !1 } = {}) {
      let I, R, N, p, m, L, f, $, Y, T, J, S, B, E
      for ({ length: L } = _, p = 0, m = '', E = [{ tag: 'JS' }], I = [], J = 0, S = !1; p < L; ) {
        switch ((($ = E[E.length - 1]), $.tag)) {
          case 'JS':
          case 'JSNonExpressionParen':
          case 'InterpolationInTemplate':
          case 'InterpolationInJSX':
            if (_[p] === '/' && (x.test(m) || s.test(m)) && ((w.lastIndex = p), (f = w.exec(_)))) {
              ;((p = w.lastIndex),
                (m = f[0]),
                (S = !0),
                yield { type: 'RegularExpressionLiteral', value: f[0], closed: f[1] !== void 0 && f[1] !== '\\' })
              continue
            }
            if (((g.lastIndex = p), (f = g.exec(_)))) {
              switch (((B = f[0]), (Y = g.lastIndex), (T = B), B)) {
                case '(':
                  ;(m === '?NonExpressionParenKeyword' && E.push({ tag: 'JSNonExpressionParen', nesting: J }),
                    J++,
                    (S = !1))
                  break
                case ')':
                  ...
                  break
                case '{':
                  ;((g.lastIndex = 0), (N = !u.test(m) && (x.test(m) || s.test(m))), I.push(N), (S = !1))
                  break
                case '}':
                  switch ($.tag) {
                    case 'InterpolationInTemplate':
                      if (I.length === $.nesting) {
                        ;((c.lastIndex = p),
                          ...
                          (m = f[0]),
                          f[1] === '${'
                            ? ((m = '?InterpolationInTemplate'),
                              (S = !1),
                              yield { type: 'TemplateMiddle', value: f[0] })
                            : (E.pop(), (S = !0), yield { type: 'TemplateTail', value: f[0], closed: f[1] === '`' }))
                        continue
                      }
                      break
                    case 'InterpolationInJSX':
                      if (I.length === $.nesting) {
                        ;(E.pop(), (p += 1), (m = '}'), yield { type: 'JSXPunctuator', value: '}' })
                        continue
                      }
                  }
                ...
                case '--':
                  ...
                  break
                case '<':
                  if (P && (x.test(m) || s.test(m))) {
                    ;(E.push({ tag: 'JSXTag' }), (p += 1), (m = '<'), yield { type: 'JSXPunctuator', value: B })
                    continue
                  }
                  S = !1
                  break
              ...
              ;((p = Y), (m = T), yield { type: 'Punctuator', value: B })
              continue
            }
            if (((n.lastIndex = p), (f = n.exec(_)))) {
              switch (((p = n.lastIndex), (T = f[0]), f[0])) {
                ...
                case 'while':
                case 'with':
                  m !== '.' && m !== '?.' && (T = '?NonExpressionParenKeyword')
              }
              ;((m = T),
                (S = !s.test(f[0])),
                yield { type: f[1] === '#' ? 'PrivateIdentifier' : 'IdentifierName', value: f[0] })
              continue
            }
            if (((y.lastIndex = p), (f = y.exec(_)))) {
              ;((p = y.lastIndex),
                (m = f[0]),
                (S = !0),
                yield { type: 'StringLiteral', value: f[0], closed: f[2] !== void 0 })
              continue
            }
            if (((h.lastIndex = p), (f = h.exec(_)))) {
              ;((p = h.lastIndex), (m = f[0]), (S = !0), yield { type: 'NumericLiteral', value: f[0] })
              continue
            }
            if (((c.lastIndex = p), (f = c.exec(_)))) {
              ;((p = c.lastIndex),
                ...
                f[1] === '${'
                  ? ((m = '?InterpolationInTemplate'),
                    E.push({ tag: 'InterpolationInTemplate', nesting: I.length }),
                    (S = !1),
                    yield { type: 'TemplateHead', value: f[0] })
                  : ((S = !0), yield { type: 'NoSubstitutionTemplate', value: f[0], closed: f[1] === '`' }))
              continue
            }
            break
          case 'JSXTag':
          case 'JSXTagEnd':
            if (((t.lastIndex = p), (f = t.exec(_)))) {
              switch (((p = t.lastIndex), (T = f[0]), f[0])) {
                ...
                case '>':
                  ;(E.pop(),
                    m === '/' || $.tag === 'JSXTagEnd' ? ((T = '?JSX'), (S = !0)) : E.push({ tag: 'JSXChildren' }))
                  break
                case '{':
                  ;(E.push({ tag: 'InterpolationInJSX', nesting: I.length }), (T = '?InterpolationInJSX'), (S = !1))
                  break
                case '/':
                  m === '<' && (E.pop(), E[E.length - 1].tag === 'JSXChildren' && E.pop(), E.push({ tag: 'JSXTagEnd' }))
              }
              ;((m = T), yield { type: 'JSXPunctuator', value: f[0] })
              continue
            }
            if (((e.lastIndex = p), (f = e.exec(_)))) {
              ;((p = e.lastIndex), (m = f[0]), yield { type: 'JSXIdentifier', value: f[0] })
              continue
            }
            if (((r.lastIndex = p), (f = r.exec(_)))) {
              ;((p = r.lastIndex), (m = f[0]), yield { type: 'JSXString', value: f[0], closed: f[2] !== void 0 })
              continue
            }
            break
          case 'JSXChildren':
            if (((i.lastIndex = p), (f = i.exec(_)))) {
              ;((p = i.lastIndex), (m = f[0]), yield { type: 'JSXText', value: f[0] })
              continue
            }
            switch (_[p]) {
              case '<':
                ;(E.push({ tag: 'JSXTag' }), p++, (m = '<'), yield { type: 'JSXPunctuator', value: '<' })
                continue
              case '{':
                ;(E.push({ tag: 'InterpolationInJSX', nesting: I.length }),
                  p++,
                  (m = '?InterpolationInJSX'),
                  (S = !1),
        ...
        if (((o.lastIndex = p), (f = o.exec(_)))) {
          ;((p = o.lastIndex),
            (S = !1),
            a.test(m) && (m = '?NoLineTerminatorHere'),
            yield { type: 'LineTerminatorSequence', value: f[0] })
          continue
        }
        if (((l.lastIndex = p), (f = l.exec(_)))) {
          ;((p = l.lastIndex),
            d.test(f[0]) && ((S = !1), a.test(m) && (m = '?NoLineTerminatorHere')),
            yield { type: 'MultiLineComment', value: f[0], closed: f[1] !== void 0 })
          continue
        }
        if (((b.lastIndex = p), (f = b.exec(_)))) {
          ;((p = b.lastIndex), (S = !1), yield { type: 'SingleLineComment', value: f[0] })
          continue
        }
        ;((R = String.fromCodePoint(_.codePointAt(p))),
          ...
          (m = R),
          (S = !1),
          yield { type: $.tag.startsWith('JSX') ? 'JSXInvalid' : 'Invalid', value: R })
      }
    }),
    V
  )
...
function he(n) {
  ...
  if ((r.startsWith('async ') && (r = r.slice(6)), r.startsWith('http:') || r.startsWith('https:'))) {
    const i = new URL(r)
    ;(i.searchParams.delete('import'), i.searchParams.delete('browserv'), (r = i.pathname + i.hash + i.search))
  }
  if (r.startsWith('/@fs/')) {
...
function et(n) {
  ...
  if (
    Qe.test(e) ||
    (e.includes(' > eval') && (e = e.replace(/ line (\d+)(?: > eval line \d+)* > eval:\d+:\d+/g, ':$1')),
  ...
  return !s || !a || !o ? null : { file: s, method: i || '', line: Number.parseInt(a), column: Number.parseInt(o) }
}
function tt(n) {
  const e = n.trim()
...
function rt(n) {
  ...
  return !l || !s || !a
    ...
    : (o.startsWith('async ') && (o = o.slice(6)),
      ...
      { method: o, file: l, line: Number.parseInt(s), column: Number.parseInt(a) })
}
function nt(n) {
  ...
  return {
    hoisted(r) {
      if (typeof r !== 'function') {throw new TypeError(`vi.hoisted() expects a function, but received a ${typeof r}`)}
      return r()
    },
    mock(r, i) {
      if (typeof r !== 'string') {throw new TypeError(`vi.mock() expects a string path, but received a ${typeof r}`)}
      const s = A('mock')
      t().queueMock(r, s, typeof i === 'function' ? () => i(() => t().importActual(r, s)) : i)
    },
    unmock(r) {
      if (typeof r !== 'string') {throw new TypeError(`vi.unmock() expects a string path, but received a ${typeof r}`)}
      t().queueUnmock(r, A('unmock'))
    },
    doMock(r, i) {
      if (typeof r !== 'string') {throw new TypeError(`vi.doMock() expects a string path, but received a ${typeof r}`)}
      const s = A('doMock')
      t().queueMock(r, s, typeof i === 'function' ? () => i(() => t().importActual(r, s)) : i)
    },
    doUnmock(r) {
      if (typeof r !== 'string') {throw new TypeError(`vi.doUnmock() expects a string path, but received a ${typeof r}`)}
...
`),
    r = t.findIndex((s) => s.includes(` at Object.${n}`) || s.includes(`${n}@`)),
    i = tt(t[r + 1])
  return i?.file || ''
}
const { now: oe } = Date
class it {
  ...
  mockedIds = new Set()
  constructor(e, t, r, i) {
    ;((this.interceptor = e), (this.rpc = t), (this.spyOn = r), (this.config = i))
  }
  async prepare() {
  ...
  async importActual(e, t) {
    ...
    if (r == null) {throw new Error(`[vitest] Cannot resolve "${e}" imported from "${t}"`)}
    const i = $e(r.id),
    ...
    return this.wrapDynamicImport(() => import(o)).then((l) => {
      ...
      return d?.__esModule
        ? d
        : { ...((typeof d === 'object' && !Array.isArray(d)) || typeof d === 'function' ? d : {}), default: d }
    })
  }
  async importMock(e, t) {
    await this.prepare()
    const { resolvedId: r, resolvedUrl: i, redirectUrl: s } = await this.rpc.resolveMock(e, t, { mock: 'auto' }),
    ...
    if (o.type === 'automock' || o.type === 'autospy') {
      const l = new URL(`/@id/${r}`, location.href),
        ...
        h = await me(() => import(`${l.pathname}${d}&mock=${o.type}${l.hash}`), [], import.meta.url)
      return this.mockObject(h, o.type)
    }
    return import(o.redirect)
  }
  mockObject(e, t = 'automock') {
    return ye({ globalConstructors: { Object, Function, Array, Map, RegExp }, spyOn: this.spyOn, type: t }, e)
  }
  queueMock(e, t, r) {
    const i = this.rpc
      .resolveMock(e, t, { mock: typeof r === 'function' ? 'factory' : r?.spy ? 'spy' : 'auto' })
      .then(async ({ redirectUrl: s, resolvedId: a, resolvedUrl: o, needsInterop: l, mockType: d }) => {
        ...
        const g =
            typeof r === 'function'
              ? async () => {
                  const y = await r()
                  return l ? { default: y } : y
                }
              : void 0,
          w = typeof s === 'string' ? new URL(this.resolveMockPath(X(s)), location.href).toString() : null
        let b
        ;(d === 'manual'
  ...
  queueUnmock(e, t) {
    const r = this.rpc
      ...
      .then(async (i) => {
        ...
        ;(this.mockedIds.add(i.id), this.registry.delete(s), await this.interceptor.delete(s))
      })
      .finally(() => {
        this.queue.delete(r)
      })
  ...
  resolveMockPath(e) {
    const t = this.config,
      r = xe('/@fs/', t.root)
    return e.startsWith(t.root) ? e.slice(t.root.length) : e.startsWith(r) ? e.slice(r.length) : e
  }
}
const ot = /(\?|&)v=\w{8}/
function X(n) {
...
const W = (n) => {
  switch (n) {
    ...
    case 'resolveMock':
      return Promise.resolve({ mockType: 'dummy', resolvedId: '', resolvedUrl: '', redirectUrl: '', needsInterop: !1 })
    case 'invalidate':
...
function at(n) {
  ...
  return ((globalThis.__vitest_mocker__ = e), nt({ globalThisKey: '__vitest_mocker__' }))
}
