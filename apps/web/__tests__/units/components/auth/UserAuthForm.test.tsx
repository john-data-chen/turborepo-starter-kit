...
vi.mock('next-intl', () => ({
  useTranslations: vi.fn(() => (key: string) => {
    ...
    if (key === 'emailPlaceholder') return 'm@example.com'
    if (key === 'continueButton') return 'Continue'
    if (key === 'invalidEmail') return 'Invalid email address'
    return key
  })
}))
...
vi.mock('@repo/ui', () => ({
  ...
  FormMessage: vi.fn(() => <div data-testid="form-message"></div>),
